...
class Switcher(object):
    ...
    def option_gen_fair_cake(self):
        ...
        for i in range(1, int(n_nodes / 2) + 1):
            ...
            if not analyze:
                nx.write_graph6(fc, path + "/graph6/" + str(n_nodes) + "n_" + str(i) + "ch_FairCake_tmp.g6", header=False)
            ...
            print("Graphs stored in g6 format into the file " + path + "/graph6/" + str(n_nodes) + "n_" + str(i) + "ch_FairCake.g6")
